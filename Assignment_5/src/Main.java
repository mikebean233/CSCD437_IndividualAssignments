...
public class Main implements Runnable {
    ...
    private void buildMenu(){
        ...
        menuMap.put("e", new RegexMenuItem("^((((0[13578]|1[02])-(0[1-9]|[12][0-9]|3[01]))|((0[469]|11)-(0[1-9]|[12][0-9]|30))|(02-(01|1[0-9]|2[0-9])))-[0-9]{2}([13579][26]|[02468][048]))|((((0[13578]|1[02])-(0[1-9]|[12][0-9]|3[01]))|((0[469]|11)-(0[1-9]|[12][0-9]|30))|(02-(01|1[0-9]|2[0-8])))-[0-9]{2}([02468][1235679]|[13579][01345789]))$","Date in MM-DD-YYYY format"));
